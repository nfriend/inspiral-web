...
(function ($) {
    ...
    function deleteImage(imgurId) {
        ...
        $.ajax({
            type: 'POST',
            url: isDev ? 'http://dev.nathanfriend.com/inspiral-web/deleteimage.php' : '../deleteimage.php',
            data: {
                imgur_id: imgurId
            },
    ...
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: (isDev ? 'http://dev.nathanfriend.com/inspiral-web/getimages.php' : '../getimages.php') + '?page=' + (pageNumber - 1) + '&perPage=' + itemsPerPage,
