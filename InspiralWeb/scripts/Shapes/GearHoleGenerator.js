...
(function (InspiralWeb) {
    ...
    (function (Shapes) {
        'use strict';
        var GearHoleGenerator = /** @class */ (function () {
            function GearHoleGenerator() {
            }
            GearHoleGenerator.prototype.generate = function (options) {
                var returnHoleOptions = new Array(), holePositionRadiusDelta = (options.radius - 2 * options.holePositionBuffer) / options.holeCount, holeAngle = 0, holePositionRadius = options.radius - options.holePositionBuffer;
            ...
            return GearHoleGenerator;
        }());
        Shapes.GearHoleGenerator = GearHoleGenerator;
    })(Shapes = InspiralWeb.Shapes || (InspiralWeb.Shapes = {}));
})(InspiralWeb || (InspiralWeb = {}));
//# sourceMappingURL=GearHoleGenerator.js.map