...
module InspiralWeb.Interaction {
    ...
    export function attachDragHandlers(svgContainer, rotatingGear, canvas: HTMLCanvasElement, rotater: Shapes.Rotater,
        rotatingGearOptions: Shapes.GearOptions, holeOptions: Shapes.HoleOptions, cursorTracker) {
