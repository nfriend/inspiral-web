    ...
    (function (Shapes) {
        function RingGear(options) {
            ...
            for (var i = 0; i < options.outerToothCount; i++) {
                ...
                pathBuilder.add(new Spirograph.SVG.ACommand(options.outerRadius, options.outerRadius, 0, false, true, options.outerRadius * Math.cos(Spirograph.Utility.toRadians(angle + delta * 4 / 6)), options.outerRadius * Math.sin(Spirograph.Utility.toRadians(angle + delta * 4 / 6))));
            ...
            for (var i = 0; i < options.innerToothCount; i++) {
                pathBuilder.add(new Spirograph.SVG.ACommand(options.innerRadius, options.innerRadius, 0, false, true, options.innerRadius * Math.cos(Spirograph.Utility.toRadians(angle + delta * 1 / 6)), options.innerRadius * Math.sin(Spirograph.Utility.toRadians(angle + delta * 1 / 6))));
