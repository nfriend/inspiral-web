...
(function (Spirograph) {
    (function (Interaction) {
        ...
        function changeFixedGear(svgContainer, newGearType, newGearOptions) {
            ...
            var fixedGear = svgContainer.append("g").attr("class", "gear ring-gear fixed color-changing").attr("transform", "translate(" + Spirograph.getSvgCenterX() + "," + Spirograph.getSvgCenterY() + ")").datum(newGearOptions).append("path").attr("d", shapeToMake);
