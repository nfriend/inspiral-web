...
function extentTest() {
    ...
    d3.extent([5, 1, 2, 3, 4], function (d) {
        return d;
    });
    d3.extent([20, 3], function (d) {
        return d;
    });
    d3.extent([3, 20], function (d) {
        return d;
    });
    d3.extent(["c", "a", "b"], function (d) {
        return d;
    });
    d3.extent(["20", "3"], function (d) {
        return d;
    ...
    d3.extent([NaN, 1, 2, 3, 4, 5], function (d) {
        return d;
    });
    d3.extent([o, 1, 2, 3, 4, 5], function (d) {
        return d;
    });
    d3.extent([1, 2, 3, 4, 5, NaN], function (d) {
        return d;
    });
    d3.extent([1, 2, 3, 4, 5, o], function (d) {
        return d;
    });
    d3.extent([10, null, 3, undefined, 5, NaN], function (d) {
        return d;
    });
    d3.extent([-1, null, -3, undefined, -5, NaN], function (d) {
        return d;
    });
    d3.extent([20, "3"], function (d) {
        return d;
...
//# sourceMappingURL=d3-tests.js.map
